...
```bash
curl "$CODE_STORAGE_BASE_URL/repos/$REPO_NAME_ENCODED/merge/preview?source_branch=feature/demo&source_is_ephemeral=true&target_branch=main&target_is_ephemeral=false&include_content=true" \
  -H "Authorization: Bearer $CODE_STORAGE_TOKEN"
```
